...
public class GameManager : MonoBehaviour
{
	...
	public void PlaceCard(CardInfo _cardPlayed, Player _owner)
	{
		...
		//// Change the card's location to Played
	...
	public void ChangeTurn()
	{
		do
		{
			...
			// Continue as long as the game isn't over && the turn player can't play a card
			// TODO: Temporary code! Turn player will have to press a button to skip turn in final version, for player feedback
		} while (winners.Count < players.Count && !players[turnPlayer].CanPlay());
	}
